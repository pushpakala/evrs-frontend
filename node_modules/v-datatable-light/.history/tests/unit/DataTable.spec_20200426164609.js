...
describe('DataTable.vue', () => {
  describe('Rendering tests', () => {
    ...
    it('should renders the arrows to sort when just one headerField sent sortable as true ', () => {
      ...
      console.log(ths.at(1).html());

      const firstThClass = ths.at(1).find('.header-cell-1')
      expect(firstThClass.exists()).toBe(true)
      const secondThClass = ths.at(2).find('.header-cell-test')
      expect(secondThClass.exists()).toBe(true)

      // const thirdThClass = ths.at(3).find('.header-cell-test')
