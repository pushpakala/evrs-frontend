<template>
  <div id="app">
    ...
    <DataTable
      ...
      :css="datatableCss"
      :headerColumnsCss="headerColumnsCss"
      :rowsCss="rowsCss"
...
#app .v-datatable-light .header-cell-2 {
  color: red;
}

#app .v-datatable-light .header-cell-3 {
  color: green;
}

#app .v-datatable-light .header-cell-4 {
  color: yellow;
}

#app .v-datatable-light .header-cell-5 {
  color: pink;
}

#app .v-datatable-light .header-cell-6 {
  color: blueviolet;
}

#app .v-datatable-light .cell-2 {
  color: goldenrod;
}

#app .v-datatable-light .cell-2 .column-2{
  color: purple;
}

#app .v-datatable-light .cell-3 {
  color: silver;
}

#app .v-datatable-light .cell-5 .column-1, #app .v-datatable-light .cell-5 .column-6 {
  color: rosybrown;
}

#app .v-datatable-light .cell-7 .column-4 {
  color: steelblue;
}

#app .v-datatable-light .cell-9 .column-5 {
  color: springgreen;
}

#app .v-datatable-light .cell-4 {
...
export default {
  ...
  data: function () {
    return {
      ...
      headerColumnsCss: ['header-cell-1', 'header-cell-2', 'header-cell-3', 'header-cell-4', 'header-cell-5', 'header-cell-6', 'header-cell-7'],
      rowsCss: ['cell-1', 'cell-2', 'cell-3', 'cell-4', 'cell-5', 'cell-6', 'cell-7', 'cell-8', 'cell-9'],
      paginationCss: {
